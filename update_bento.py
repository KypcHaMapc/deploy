...
html_path = r'c:\Users\Алекс\OneDrive\Desktop\OrbitaAI\index.html'
css_path = r'c:\Users\Алекс\OneDrive\Desktop\OrbitaAI\css\style.css'

with open(html_path, 'r', encoding='utf-8') as f:
    html_content = f.read()

new_html = """    <main class="page-main" id="home">
...
# Replace all content between <main> and </main> using literal match or regex
html_content = re.sub(r'<main>.*?</main>', new_html, html_content, flags=re.DOTALL)
...
prefix = css_content.split('/* Hero Section */')[0]
